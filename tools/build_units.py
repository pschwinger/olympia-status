...
<a href="units.html" style="text-decoration:none;font:700 12px Arial,Helvetica,sans-serif;padding:5px 9px;border-radius:7px;background:#3a6ea5;color:#fff">🏛 Units</a>
<a href="artifacts.html" style="text-decoration:none;font:700 12px Arial,Helvetica,sans-serif;padding:5px 9px;border-radius:7px;background:#a06a24;color:#fff">🏺 Artifacts</a>
<a href="selection.html" style="text-decoration:none;font:700 12px Arial,Helvetica,sans-serif;padding:5px 9px;border-radius:7px;background:#c9a227;color:#1f1f1f">★ Final Selection</a>
<a href="board/review.html" style="text-decoration:none;font:700 12px Arial,Helvetica,sans-serif;padding:5px 9px;border-radius:7px;background:#5a5a5a;color:#fff">🗄 Working room</a>
<a href="spk.html" style="text-decoration:none;font:700 12px Arial,Helvetica,sans-serif;padding:5px 9px;border-radius:7px;background:#8a2b2b;color:#fff">🎞 SPK / SMB</a>
...
.card3{background:#f7f7f7;border:1px solid #dedede;border-top:4px solid #2FB89F;border-radius:12px;padding:20px 20px 8px}
.role{font-family:Arial,sans-serif;font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#7a7a7a;display:block;margin-bottom:6px}
.card3 h3{font-size:1.35rem;margin:0 0 6px;color:#1f1f1f}.card3>p{font-size:.98rem;color:#4a4a4a;margin:0 0 10px}
.card3 ul{margin:0;padding:0;list-style:none}.card3 li{font-size:.95rem;color:#4a4a4a;padding:8px 0 8px 16px;position:relative;border-top:1px solid #e6e6e6}
.card3 li:first-child{border-top:0}.card3 li:before{content:"";position:absolute;left:2px;top:15px;width:6px;height:6px;border-radius:50%;background:#6F6AAF}
.pull{border-left:3px solid #2FB89F;padding:4px 0 4px 16px;margin:20px 0;font-size:1.1rem;color:#2b2b2b;max-width:64ch}
.scale{background:#f7f7f7;border:1px solid #dedede;border-radius:12px;padding:22px 22px 10px;margin-bottom:16px}
.scalehead{display:flex;align-items:center;gap:14px;margin-bottom:6px}.scalehead h3{margin:0;font-size:1.3rem;color:#1f1f1f}
.num{font-family:Arial,sans-serif;font-size:12px;color:#fff;padding:3px 9px;border-radius:5px;font-weight:700;display:inline-block}
.scale .claim{font-size:1.05rem;color:#2b2b2b;margin:4px 0 14px;max-width:70ch}
.scale table{width:100%;border-collapse:collapse}.scale td{padding:11px 12px 11px 0;font-size:.98rem;color:#4a4a4a;border-top:1px solid #e6e6e6;vertical-align:top}
.scale td:first-child{width:33%;color:#1f1f1f;font-weight:700;padding-right:22px}.scale tr:first-child td{border-top:0}
.step{flex:1 1 150px;min-width:140px}
</style>"""
